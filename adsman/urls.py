...
#adsman
    (r'^$', 'tourprom.adsman.views.get_page_list'),
    (r'^(?P<page_id>\d+)/$', 'tourprom.adsman.views.get_page'),
    ...
    (r'^(?P<page_id>\d+)/preview_post$', 'tourprom.adsman.views.preview_post'),# preview new
