...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FavoriteAdvert'
        db.create_table('adsman_favoriteadvert', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('advert', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adsman.Advert'])),
        ))
        db.send_create_signal('adsman', ['FavoriteAdvert'])

        # Adding model 'AdvertDate'
        db.create_table('adsman_advertdate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('advert', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bulletins', to=orm['adsman.Advert'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('advertiser', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['advertisers.Advertiser'])),
        ))
        db.send_create_signal('adsman', ['AdvertDate'])

        # Adding model 'Advert'
        db.create_table('adsman_advert', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['adsman.AdsPage'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['advertisers.Advertiser'])),
            ...
            ('price_rub', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('active_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ...
        db.send_create_signal('adsman', ['Advert'])

        # Adding model 'AdvertEntry'
        db.create_table('adsman_advertentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('advert', self.gf('django.db.models.fields.related.ForeignKey')(related_name='entries', to=orm['adsman.Advert'])),
        ...
        db.send_create_signal('adsman', ['AdvertEntry'])


    def backwards(self, orm):
        
        # Deleting model 'FavoriteAdvert'
        db.delete_table('adsman_favoriteadvert')

        # Deleting model 'AdvertDate'
        db.delete_table('adsman_advertdate')

        # Deleting model 'Advert'
        db.delete_table('adsman_advert')

        # Deleting model 'AdvertEntry'
        db.delete_table('adsman_advertentry')
    ...
    models = {
        ...
        'adsman.advertdate': {
            'Meta': {'ordering': "['-date']", 'object_name': 'AdvertDate'},
            'advert': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bulletins'", 'to': "orm['adsman.Advert']"}),
            'advertiser': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['advertisers.Advertiser']"}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'adsman.advertentry': {
            'Meta': {'object_name': 'AdvertEntry'},
            'advert': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entries'", 'to': "orm['adsman.Advert']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'position': ('django.db.models.fields.SmallIntegerField', [], {}),
            'value': ('django.db.models.fields.CharField', [], {'max_length': '500'})
        ...
        'adsman.favoriteadvert': {
            'Meta': {'object_name': 'FavoriteAdvert'},
            'advert': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['adsman.Advert']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
