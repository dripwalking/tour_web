...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdsPage.limit'
        db.add_column('adsman_adspage', 'limit', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AdsPage.limit'
        db.delete_column('adsman_adspage', 'limit')
    ...
    models = {
        ...
        'countries.contentnode': {
            'Meta': {'ordering': "['tree_id', 'lft']", 'object_name': 'ContentNode'},
